...
namespace Referee.Web.Controllers.MVC
{
    ...
    public class AccountController : Controller
    {
        ...
        private static void AddFoosBallPlayer(ApplicationUser user)
        {
            var player = new Player {Name = user.UserName, AccountEmail = user.Email};
            using (var context = new RefereeDbContext())
            {
